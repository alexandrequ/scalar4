...
/*
    ...
    Description: 
        ...
        %MODULE_LONG_NAME% v4.90 (2018-11-26)
        ...
        <b>Fixes: </b>
          - Error in color converter function name for 24-bit color depth
          - Error in PIC24FJ256DA210 driver that could cause an array out of bounds issue leading to memory corruption
          - Error in primitive driver that could lock up the primitive driver if a character outside of the allowed range is requested to be printed
          - Error that could cause one row of pixels to be draw incorrectly on an image when using transparency
          - Gradient coloring not working with objects with rounded edges
                    
        <b>Changes: </b>
          - Remove extraneous includes from files resulting in circular references and extraneous header dependencies.
		  - Update demos to use either SST26 and SST25 for Microchip demo boards.
