...
#define LED_LED3_RED_LAT     LATAbits.LATA0
#define LED_LED3_GREEN_LAT   LATAbits.LATA1
#define LED_LED3_BLUE_LAT    LATCbits.LATC7
#define LED_LED1_LAT         LATAbits.LATA8
#define LED_LED2_LAT         LATAbits.LATA9

#define LED_LED3_RED_TRIS    TRISAbits.TRISA0
#define LED_LED3_GREEN_TRIS  TRISAbits.TRISA1
#define LED_LED3_BLUE_TRIS   TRISCbits.TRISC7
#define LED_LED1_TRIS        TRISAbits.TRISA8
#define LED_LED2_TRIS        TRISAbits.TRISA9
