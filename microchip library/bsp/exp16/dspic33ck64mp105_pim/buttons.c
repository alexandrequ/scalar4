...
/*** Button Definitions *********************************************/
//      S1  is MCLR button
#define S3_PORT  PORTDbits.RD10
#define S6_PORT  PORTBbits.RB3
#define S4_PORT  PORTDbits.RD13

#define S3_TRIS  TRISDbits.TRISD10
...
void BUTTON_Enable(BUTTON button)
{
    ...
    {        
        case BUTTON_S3:
            ANSELDbits.ANSELD10 = PIN_DIGITAL;
            S3_TRIS = PIN_INPUT;
            break;

        case BUTTON_S6:
            ANSELBbits.ANSELB3 = PIN_DIGITAL;
            S6_TRIS = PIN_INPUT;
            break;
            
        case BUTTON_S4:
            ANSELDbits.ANSELD13 = PIN_DIGITAL;
            S4_TRIS = PIN_INPUT;
            break;
