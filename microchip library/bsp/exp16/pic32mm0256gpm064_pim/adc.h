...
#define ADC_CHANNEL_POTENTIOMETER       14u
#define ADC_CHANNEL_TEMPERATURE_SENSOR  18u
#define ADC_CHANNEL_MIKROBUS_A_AN       12u     //RC0
#define ADC_CHANNEL_MIKROBUS_B_AN       17u     //RA12

typedef uint16_t ADC_CHANNEL;
