...
extern uint8_gfx_image_prog __shifted_green_left_arrow[] __attribute__((space(prog), section("grc_images")));
#else
extern uint8_gfx_image_prog __shifted_green_left_arrow[] __attribute__((space(prog), section("grc_images"), aligned(2)));
#endif
 ...
 ***********************************/
#if defined (GFX_CONFIG_IMAGE_PACKED_ENABLE) && (__XC16_VERSION__ >= 1011)
extern uint8_gfx_image_prog __shifted_green_right_arrow[] __attribute__((space(prog), section("grc_images")));
#else
extern uint8_gfx_image_prog __shifted_green_right_arrow[] __attribute__((space(prog), section("grc_images"), aligned(2)));
#endif
