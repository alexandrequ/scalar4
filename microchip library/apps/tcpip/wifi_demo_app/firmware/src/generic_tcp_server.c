    ...
    2) Determine the IP address of the demo board.  This can be done several
       ...
       c) If your board is connected directly with your computer with a
          ...
          2) Open up the network status for the network adaptor that
             ...
             field.
    3) Open a command/DOS prompt.  Enable the Telnet Client feature of Windows.
       Type "telnet ip_address 9760" where ip_address is the IP address that you
       got from step 2.
...
/*****************************************************************************
  Function:
    void GenericTCPServerInit(void)

  Summary:
    Initialize the simple TCP Server.
...
#endif /* defined(STACK_USE_GENERIC_TCP_SERVER_EXAMPLE) */
