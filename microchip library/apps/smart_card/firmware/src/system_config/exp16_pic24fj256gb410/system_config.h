...
//#define SMARTCARD_SUPPORT_IN_HARDWARE
		...
		#define SMARTCARD_Drv_ClockSet()            (_RP29R=28,REFOCONHbits.RODIV = 0x04,REFOCONLbits.ROSEL= 0,REFOCONLbits.ROOUT = 1)

		//Enable UART
		#define SMARTCARD_Drv_EnableUART()	    	(U1MODEbits.UARTEN = 1)

		// Enable Clock to drive Smart Card
		#define SMARTCARD_Drv_EnableClock()	    	(REFOCONLbits.ROEN = 1)

		// Disable Clock used to drive Smart Card
		#define SMARTCARD_Drv_DisableClock()	    (REFOCONLbits.ROEN = 0)
		...
		//Reference Clock Circuit - Input Clock
		#define SMARTCARD_REF_CLOCK_POWER2_VALUE      		((uint8_t)(REFOCONHbits.RODIV-1))

		//Reference Clock Circuit - Input Clock
		#define SMARTCARD_REF_CLOCK_DIVISOR_VALUE      		(uint8_t)0

		// Frequency of clock given to smart card
		#define SMARTCARD_REF_CLOCK_TO_SMART_CARD     ((unsigned long)(SYS_CLK_FrequencySystemGet/(pow(2,REFOCONHbits.RODIV))))
		...
		//set tx pin to the value x
		#define SMARTCARD_Drv_SetRxPinData(x) 					(LATGbits.LATG9=(x))

		//Get Smart Card Present status
		#define SMARTCARD_Drv_CardPresent()	      				  1  //(PORTAbits.RA0 || !PORTAbits.RA1)

		//Get Rx Pin Data
		#define SMARTCARD_Drv_GetRxPinData()               		(PORTGbits.RG9)//original point UNIMPLEMENTED FOR gb204 eXP16 pim

		//Set Tx Pin direction
		#define SMARTCARD_Drv_TxPin_Direction(flag)    			(TRISFbits.TRISF2 = flag)

		//Set Rx Pin direction
		#define SMARTCARD_Drv_RxPin_Direction(flag)    			(TRISGbits.TRISG9 = flag)
		...
		#define SMARTCARD_Drv_CardPresent_Direction(flag) 		(TRISAbits.TRISA10 = flag)
		...
		// MAP UART Rx Pin
		#define MapUART1RxPin()							PPSIn( RP27, U1RX_FUNC )//original pin UNIMPLEMENTED FOR gb204 eXP16 pim
