...
USB_TPL usbTPL[NUM_TPL_ENTRIES] =
{
    ...
    { INIT_CL_SC_P( 3ul, 1ul, 1ul ),            0, 2, {TPL_CLASS_DRV} }, // (HID keyboard)
    { INIT_CL_SC_P( 3ul, 0ul, 0ul ),            0, 2, {TPL_CLASS_DRV} }, // (HID undefined)
    { INIT_CL_SC_P( 0xFFul, 0xFFul, 0xFFul ),   0, 0, {TPL_CLASS_DRV | TPL_IGNORE_CLASS | TPL_IGNORE_SUBCLASS | TPL_IGNORE_PROTOCOL } }, // Enumerates everything
};
